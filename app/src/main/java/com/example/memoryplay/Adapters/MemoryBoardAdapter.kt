...
class MemoryBoardAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BoardViewHolder {
        ...
        val layoutParameters =
            view.findViewById<CardView>(R.id.DummyCardView).layoutParams as ViewGroup.MarginLayoutParams
    ...
    inner class BoardViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(position: Int) {
            ...
            if (memoryCard.isFaceUp) {
                if (memoryCard.imageUrls != null) {
                    Picasso.get().load(memoryCard.imageUrls).placeholder(R.drawable.ic_placeholder)
                        .into(imageButton)
                } else {
            ...
            val colorStateChange = if (memoryCard.isMatched) ContextCompat.getColorStateList(
                context,
                R.color.gray
            ) else null
